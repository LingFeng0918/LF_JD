...
let utils = {
	...
	encrypt7: function (m, j) {
        try {
            var ye = M.split("").reverse().join("");
            var we = (j + "000000").slice(0, 13);
            var pe = we.slice(9, 12);
            var xe = ye + pe;
            var Se = [];
            var be = "";
            for (var Pe = 0; Pe < we.length; Pe++) {
                var Te = (we.charCodeAt(Pe) & xe.charCodeAt(Pe)).toString(16);
                Se.push(Te)
            }
            be = Se.join("");
            return be;
    ...
    getKey: function (e, t, n) {
        ...
        return {
            ...
            9: function() {
                var e = r;
                if (!c.kwNsM(c.rqmtt, e(368, "fQGk")))
                    return l.default["encry" + e(436, "keJ8")](o, i)
            },
            A: function() {
                var e = r;
                if (c.ilRma(c.NlmSP, c[r(419, "QOd9")]))
                    return l[e(414, ")XB^") + "lt"]["encry" + e(363, "8O@$")](o, i)
            }
        } [e]()
    },
    ...
    gettoken: function () {
        ...
        // let ua = $.ua;
        //console.info(ua)
        var body = `content={"appname":"50086","whwswswws":"aB5GjTk8gq1FD7MoypZ7WZw","jdkey":"1201e4461b24640164a706c0a3444fd79de6577f","body":{"platform":"1"}}`;
        //var body = `content={"appname":`+appname+`,"whwswswws":"zY-h-L2rEyzf4aeeiHvla0A","jdkey":"-9244274aea75-9b70204d5bf7fe86-064b333c6d4ab9f120f672d0138250b8a52fd","body":{"platform":"1"}}`;
        console.info(body)
    ...
    get_risk_result: async function ($) {
        ...
        $.joyytoken_count++;
        console.log("$.joyytoken_count: "+$.joyytoken_count);
        console.log("$.joyytoken: "+$.joyytoken);
        ...
        data = {
            ...
            jj: 1,
            cs: hexMD5("Object.P.<computed>=&HTMLDocument.Ut.<computed>=https://storage.360buyimg.com/babel/01159125/3302163/production/dev/index.bundle.1d4426cef41024b40daf.js"),
            np: 'iPhone',
            t: time,
            jk: `${$.UUID}`,
            fpb: '',
